...
const UserContributionsPage = () => {
  ...
  const fetchContributions = async () => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/request/my-contributions`,
        {
          method: "GET",
          headers: {
  ...
  const handleResourceSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/request/contribute`,
        {
          method: "POST",
          headers: {
    ...
    try {
      ...
      if (!questionForm.correctOption) {
        toast.current.show({
          severity: "error",
          summary: "Error",
          detail: "Please select a correct option",
        });
        return;
      }
      ...
      if (correctIndex < 0 || correctIndex >= filteredOptions.length) {
        toast.current.show({
          severity: "error",
          summary: "Error",
          detail: "Invalid correct option selected",
        });
        return;
      }
  ...
  const showFeedbackModal = (contribution) => {
    ...
    const feedback =
      contribution.feedback || "No specific feedback was provided.";
  ...
  const StatusBadge = ({ status }) => {
    ...
    return (
      <span
        className={`px-3 py-1 inline-flex items-center gap-1 rounded-full text-xs font-medium border ${getStatusStyles()}`}
      >
        {getStatusIcon()}
  ...
  return (
    <div className="flex h-[100vh] bg-white text-black">
      ...
      <div className="flex flex-col h-full w-6xl mt-8 mx-auto overflow-y-auto">
        <header className="text-black">
          <div className="container mx-auto px-4 py-6">
            <h1 className="text-2xl font-bold">Contribute</h1>
            <p className="text-gray-800">
              Share resources and questions with the community
            </p>
          </div>
        </header>
          ...
          {activeTab === "myContributions" && (
            <div>
              <div className="flex justify-between items-center gap-2 mb-6">
                <h2 className="text-l font-bold">Your Contributions</h2>
                <button
                  onClick={() => setActiveTab("contribute")}
                  className="bg-black text-white  px-3 py-2 rounded-md hover:bg-gray-800 flex justify-between items-center gap-2"
                >
              ...
              {loading ? (
                ...
                <div className="bg-gray-50 rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-500 mb-6">
                    Start contributing resources or questions to the community
                  </p>
                  <button
                    onClick={() => setActiveTab("contribute")}
                    className="bg-black text-white px-4 py-2 rounded-md hover:bg-gray-800"
                  ...
                  {contributions.map((contribution) => (
                    ...
                    >
                      <div className="p-5">
                        ...
                        <h3 className="text-s font-semibold mb-2 line-clamp-2">
                          {contribution.type === "Resource"
                            ? contribution.payload.name
                            : contribution.payload.question}
                        </h3>
                        ...
                        <div className="border-t border-gray-100 pt-3 gap-3 flex items-center justify-between">
              ...
              <div className="mb-6 w-full">
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    ...
                    All contributions are reviewed by admins before being
                    published
                  </p>
                </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap items-center gap-2 p-2 border border-gray-300 rounded-md mb-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setResourceTopicInput(e.target.value)
                          }
                          onKeyDown={(e) => {
                            if (e.key === "Enter" || e.key === ",") {
                              e.preventDefault();
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center justify-center gap-2">
                                ...
                                {questionForm.correctOption ===
                                  letterOption && <Check className="w-4 h-4" />}
                              </div>
                            </button>
                          );
                        })}
